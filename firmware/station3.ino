...
// ===== Station =====
static const char* STATION_ID = "e8a06b61-7a9e-4252-8606-cd6ebcc9f396"; // Station 3 ID - Updated to match database
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println();
  Serial.println("🔌 Booting (Station 3)...");
  ...
  SPI.begin();
  rfid.PCD_Init();
  Serial.println("📶 RFID Reader Ready (Station 3). Scan a tag...");
}
